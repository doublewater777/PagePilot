...
- GitHub Actions `CI / iOS tests` generates the ignored Xcode project with `make spm`, then runs the same full suite for pull requests targeting `main` and pushes to `main`.
